...
import rasterio
from .utils import _check_df_load, _check_geom, _check_rasterio_im_load
import numpy as np
...
from .raster import get_geo_transform
...
def footprint_mask(df, out_file=None, reference_im=None, geom_col='geometry',
                   do_transform=None, affine_obj=None, shape=(512, 512),
                   out_type='int', burn_value=1, burn_field=None):
    """Convert a dataframe of geometries to a pixel mask.
    Arguments
    ---------
    df : :class:`pandas.DataFrame` or :class:`geopandas.GeoDataFrame`
